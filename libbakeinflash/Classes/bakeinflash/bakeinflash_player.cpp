...
namespace bakeinflash
{
	...
	const char* get_bakeinflash_version()
	{
		...
		static tu_string s_bakeinflash_version("EMSDK bakeinflash " __DATE__ " " __TIME__);
#elif defined(WIN32)
...
#if !defined(__APPLE__) && !defined(WINPHONE) && !defined(__EMSCRIPTEN__)
...
#if !defined( WINPHONE) && !defined(__EMSCRIPTEN__)
