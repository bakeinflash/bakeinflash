...
#if 0 //(defined(WIN32) || defined(__GNUC__)) && !defined(iOS) && !defined(ANDROID) && !defined(TARGET_OS_MAC)
...
{
  render_handler* create_render_handler_ogles2(bool hasStencilBuffer)
    // Factory.
  {
  ...
  render_handler* create_render_handler_ogles2()
    // Factory.
  {
    return new render_handler_ogles::render_handler_ogles(false);
  }
};
