...
float s_viewport_width = 0;
float s_viewport_height = 0;
...
void Direct3DBase::CreateWindowSizeDependentResources()
{
	...
	DX::ThrowIfFailed(dxgiFactory->CreateSwapChainForCoreWindow(m_d3dDevice.Get(),	reinterpret_cast<IUnknown*>(window), &swapChainDesc, 
		nullptr, &m_swapChain));
	...
	UINT rw = (UINT) m_renderTargetSize.Width;
	UINT rh = (UINT) m_renderTargetSize.Height;
	//	CD3D11_TEXTURE2D_DESC depthStencilDesc(DXGI_FORMAT_D24_UNORM_S8_UINT, rw, rh, 1, 1,	D3D11_BIND_DEPTH_STENCIL);
	...
	//	CD3D11_VIEWPORT viewport(shift_x, shift_y, s_viewport_width, s_viewport_height);
